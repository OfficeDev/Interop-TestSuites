...
if %ERRORLEVEL% equ 2 (
echo You need to run SharePointSUTConfiguration.cmd using "Run as administrator"!
Pause
Exit
)
...
if %powershellExist% equ 1 (PowerShell.exe -ExecutionPolicy ByPass .\SharePointSUTConfiguration.ps1 '%unattendedXML%') else (echo PowerShell is not installed, you should install it first.)
