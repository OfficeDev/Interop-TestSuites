    ...
    public class S02_OperationOnContentType : TestClassBase
    {
        ...
        public void MSLISTSWS_S02_TC03_ApplyContentTypeToList_InvalidListName_WSS3()
        {
            ...
            catch (SoapException soapException)
            {
                ...
                Site.CaptureRequirementIfIsTrue(
                    isVerifyR2433,
                    2433,
                    @"[In Appendix B: Product Behavior]Implementation does not return a SOAP fault with error code 0x82000006. (<39> Section 3.1.4.6: Windows SharePoint Services 3.0 return the following SOAP fault with no error code: ""GUID should contain 32 digits with 4 dashes (xxxxxxxx-xxxx-xxxx-xxxx-xxxx-xxxxxxxxxxx)"".)");
        ...
        public void MSLISTSWS_S02_TC06_CreateContentType_ContentTypeOrderNotReturned_WSS3()
        {
            ...
            Site.CaptureRequirementIfIsNull(
                ...
                2462,
                @"[In Appendix B: Product Behavior][GetListContentTypesResponse]Implementation does not return this attribute[GetListContentTypesResult.ContentTypes.ContentTypeOrder].(<61> Section 3.1.4.19.2.2: The attribute is not returned in Windows SharePoint Services 3.0.)");
        }
        ...
        public void MSLISTSWS_S02_TC11_CreateContentType_InvalidListName_WSS3()
        {
            ...
            catch (SoapException soapException)
            {
                ...
                Site.CaptureRequirementIfIsTrue(
                    isVerifyR2438,
                    2438,
                    @"[In Appendix B: Product Behavior]Implementation does not return a SOAP fault with error code 0x82000006. (<46> Section 3.1.4.9: Windows SharePoint Services 3.0 return the following SOAP fault with no error code: ""GUID should contain 32 digits with 4 dashes (xxxxxxxx-xxxx-xxxx-xxxx-xxxx-xxxxxxxxxxx)"".)");
                isReturnSopeFault = true;
            }
        ...
        public void MSLISTSWS_S02_TC17_DeleteContentTypeXmlDocument_InvalidListName_WSS3()
        {
            ...
            catch (SoapException soapException)
            {
                ...
                Site.CaptureRequirementIfIsTrue(
                    isVerifyR2446,
                    2446,
                    @"[In Appendix B: Product Behavior]Implementation does not return a SOAP fault with error code 0x82000006. (<51> Section 3.1.4.12: Windows SharePoint Services 3.0 return the following SOAP fault with no error code: ""GUID should contain 32 digits with 4 dashes (xxxxxxxx-xxxx-xxxx-xxxx-xxxx-xxxxxxxxxxx)"".)");
                isReturnSopeFault = true;
            }
        ...
        public void MSLISTSWS_S02_TC23_DeleteContentType_InvalidListName_WSS3()
        {
            ...
            catch (SoapException soapException)
            {
                ...
                Site.CaptureRequirementIfIsTrue(
                    isVerifyR2443,
                    2443,
                    @"[In Appendix B: Product Behavior]Implementation does not return a SOAP fault with error code 0x82000006. (<49> Section 3.1.4.11: Windows SharePoint Services 3.0 return the following SOAP fault with no error code: ""GUID should contain 32 digits with 4 dashes (xxxxxxxx-xxxx-xxxx-xxxx-xxxx-xxxxxxxxxxx)"".)");
                isReturnSopeFault = true;
            }
        ...
        public void MSLISTSWS_S02_TC29_GetListContentType_InvalidListName_WSS3()
        {
            ...
            catch (SoapException soapException)
            {
                ...
                Site.CaptureRequirementIfIsTrue(
                    isVerifyR2457,
                    2457,
                    @"[In Appendix B: Product Behavior] Implementation does not return a SOAP fault with error code 0x82000006. (<58> Section 3.1.4.18: Windows SharePoint Services 3.0 return the following SOAP fault with no error code: ""GUID should contain 32 digits with 4 dashes (xxxxxxxx-xxxx-xxxx-xxxx-xxxx-xxxxxxxxxxx)"".)");
            }
        ...
        public void MSLISTSWS_S02_TC43_GetListContentTypes_InvalidListName_WSS3()
        {
            ...
            catch (SoapException soapException)
            {
                ...
                Site.CaptureRequirementIfIsTrue(
                    isVerifyR2460,
                    2460,
                    @"[In Appendix B: Product Behavior] Implementation does not return a SOAP fault with error code 0x82000006. (<60> Section 3.1.4.19.2.1: Windows SharePoint Services 3.0 return the following SOAP fault with no error code: ""GUID should contain 32 digits with 4 dashes (xxxxxxxx-xxxx-xxxx-xxxx-xxxx-xxxxxxxxxxx)"".)");
            ...
            catch (SoapException exp)
            {
                ...
                if (Common.IsRequirementEnabled(2768, this.Site))
                {
                    ...
                    Site.CaptureRequirementIfAreEqual<string>(
                       ...
                       exp.Detail.LastChild.InnerText,
                       2026,
                       @"[In UpdateContentTypeXmlDocument operation] [If listName does not correspond to a list from either of these checks, the protocol server should<81> return a SOAP fault with error code 0x82000006.] This indicates that the list does not exist or might have been deleted by another user.");
                }
            }
            finally
            {
        ...
        public void MSLISTSWS_S02_TC53_UpdateContentTypeXmlDocument_InvalidListName_WSS3()
        {
            ...
            catch (SoapException soapException)
            {
                ...
                Site.CaptureRequirementIfIsTrue(
                    isVerifyR2502,
                    2502,
                    @"[In Appendix B: Product Behavior] Implementation does not return a SOAP fault with error code 0x82000006. (<86> Section 3.1.4.29: Windows SharePoint Services 3.0 return the following SOAP fault with no error code: ""GUID should contain 32 digits with 4 dashes (xxxxxxxx-xxxx-xxxx-xxxx-xxxx-xxxxxxxxxxx)"".)");
        ...
        public void MSLISTSWS_S02_TC61_UpdateContentType_IncorrectListName()
        {
            ...
            catch (SoapException exp)
            {
                ...
                Site.CaptureRequirementIfAreEqual<string>(
                    ...
                    exp.Detail.LastChild.InnerText,
                    1975,
                    @"[In UpdateContentType operation] [If the specified listName does not correspond to a list from either of these checks, a SOAP fault should<77> be returned with error code 0x82000006.] This indicates that the list does not exist or might have been deleted by another user.");
            }
            finally
            {
        ...
        public void MSLISTSWS_S02_TC62_UpdateContentType_InvalidListName_WSS3()
        {
            ...
            catch (SoapException soapException)
            {
                ...
                Site.CaptureRequirementIfIsTrue(
                    isVerifyR2496,
                    2496,
                    @"[In Appendix B: Product Behavior] Implementation does not return a SOAP fault with error code 0x82000006. (<82> Section 3.1.4.27: Windows SharePoint Services 3.0 return the following SOAP fault with no error code: ""GUID should contain 32 digits with 4 dashes (xxxxxxxx-xxxx-xxxx-xxxx-xxxx-xxxxxxxxxxx)"".)");
        ...
        public void MSLISTSWS_S02_TC68_UpdateContentTypesXmlDocument_IncorrectListName()
        {
            ...
            if (Common.IsRequirementEnabled(2499, this.Site))
            {
                ...
                Site.CaptureRequirementIfIsTrue(
                      ...
                      2499,
                      @"[In Appendix B: Product Behavior] Implementation does not return a SOAP fault with error code 0x82000006. (<84> Section 3.1.4.28: Windows SharePoint Services 3.0 return the following SOAP fault with no error code: ""GUID should contain 32 digits with 4 dashes (xxxxxxxx-xxxx-xxxx-xxxx-xxxx-xxxxxxxxxxx)"".)");
            }
            #endregion
        }
