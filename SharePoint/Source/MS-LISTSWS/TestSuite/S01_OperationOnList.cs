namespace Microsoft.Protocols.TestSuites.MS_LISTSWS
{
    ...
    public class S01_OperationOnList : TestClassBase
    {
        ...
        public void MSLISTSWS_S01_TC04_AddListFromFeature_UnknownTemplateId()
        {
            ...
            catch (SoapException ex)
            {
                ...
                if (Common.IsRequirementEnabled(2771, this.Site))
                {
                    ...
                    errorCode,
                    2771,
                    @"[In Appendix B: Product Behavior][In AddListFromFeature operation] Implementation does returns a SOAP fault with error code 0x81072101, if the templateID provided is not one of the known list template identifiers . (<32> Section 3.1.4.4:  Windows SharePoint Services 3.0 returns a SOAP fault with error code 0x81072101.)");
                }
            }
            finally
            {
        ...
        public void MSLISTSWS_S01_TC12_DeleteNonExistentList_WSS3()
        {
            ...
            Site.CaptureRequirement(
                            2448,
                            @"[In Appendix B: Product Behavior]Implementation does not return a SOAP fault with error code 0x82000006. (<47> Section 3.1.4.13: Windows SharePoint Services 3.0 return the following SOAP fault with no error code: ""GUID should contain 32 digits with 4 dashes (xxxxxxxx-xxxx-xxxx-xxxx-xxxx-xxxxxxxxxxx)"".)");
        }
        ...
        public void MSLISTSWS_S01_TC17_GetListAndView_WSS3()
        {
            ...
            catch (SoapException exp)
            {
                ...
                Site.CaptureRequirement(
                                    2454,
                                    @"[In Appendix B: Product Behavior]Implementation does not return a SOAP fault with error code 0x82000006. (<51> Section 3.1.4.16: Windows SharePoint Services 3.0 return the following SOAP fault with no error code: ""GUID should contain 32 digits with 4 dashes (xxxxxxxx-xxxx-xxxx-xxxx-xxxx-xxxxxxxxxxx)"".)");
            }
        ...
        public void MSLISTSWS_S01_TC21_GetList_WSS3()
        {
            ...
            catch (SoapException exp)
            {
                ...
                Site.CaptureRequirement(
                                    2452,
                                    @"[In Appendix B: Product Behavior]Implementation does not return a SOAP fault with error code 0x82000006. (<50> Section 3.1.4.15: Windows SharePoint Services 3.0 return the following SOAP fault with no error code: ""GUID should contain 32 digits with 4 dashes (xxxxxxxx-xxxx-xxxx-xxxx-xxxx-xxxxxxxxxxx)"".)");
            }
