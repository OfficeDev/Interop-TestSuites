    ...
    public class S04_OperationOnAttachment : TestClassBase
    {
        ...
        public void MSLISTSWS_S04_TC04_AddAttachment_SP3()
        {
            ...
            Site.CaptureRequirementIfIsTrue(
                ...
                2426,
                @"[In Appendix B: Product Behavior]Implementation does not return a SOAP fault with error code 0x82000006. (<33> Section 3.1.4.1: Windows SharePoint Services 3.0 return the following SOAP fault with no error code: ""GUID should contain 32 digits with 4 dashes (xxxxxxxx-xxxx-xxxx-xxxx-xxxx-xxxxxxxxxxx)"".)");
        ...
        public void MSLISTSWS_S04_TC09_DeleteAttachment_NonExistentListName_WSS3()
        {
            ...
            Site.CaptureRequirementIfIsTrue(
                        ...
                        2440,
                        @"[In Appendix B: Product Behavior]Implementation does not return a SOAP fault with error code 0x82000006. (<47> Section 3.1.4.10: Windows SharePoint Services 3.0 return the following SOAP fault with no error code: ""GUID should contain 32 digits with 4 dashes (xxxxxxxx-xxxx-xxxx-xxxx-xxxx-xxxxxxxxxxx)"".)");
            #endregion
        }
        ...
        public void MSLISTSWS_S04_TC13_GetAttachmentCollection_NonExistentListName_WSS3()
        {
            ...
            Site.CaptureRequirementIfIsTrue(
                        expectederrorString.IndexOf(errorString, StringComparison.OrdinalIgnoreCase) >= 0,
                        2450,
                        @"[In Appendix B: Product Behavior]Implementation does not return a SOAP fault with error code 0x82000006. (<53> Section 3.1.4.14: Windows SharePoint Services 3.0 return the following SOAP fault with no error code: ""GUID should contain 32 digits with 4 dashes (xxxxxxxx-xxxx-xxxx-xxxx-xxxx-xxxxxxxxxxx)"".)");
            ...
            catch (SoapException ex)
            {
                ...
                if (Common.IsRequirementEnabled(30371, this.Site))
                {
                    ...
                    Site.CaptureRequirementIfIsTrue(
                            ...
                            + @" if the listItemID is a negative value. (<54> Section 3.1.4.14: wss3 return the following SOAP fault with no error code: ""Value does not fall within the expected range."")");
                }
