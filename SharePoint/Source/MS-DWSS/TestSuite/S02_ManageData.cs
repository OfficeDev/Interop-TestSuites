    ...
    public class S02_ManageData : TestClassBase
    {
        ...
        public void MSDWSS_S02_TC06_GetDwsMetaData_MinimalIsFalse()
        {
            ...
            this.Site.CaptureRequirementIfIsTrue(
                isVerifiedR628,
                628,
                @"[In ListInfo] The following elements MUST be present if, and only if, the user has that permission: InsertListItems, EditListItems, DeleteListItems, and ManageLists.");
            ...
            if (string.Equals(sutVersion, "SharePointFoundation2013") || string.Equals(sutVersion, "SharePointServer2013") || string.Equals(sutVersion, "SharePointServer2016") || string.Equals(sutVersion, "SharePointServer2019") || string.Equals(sutVersion, "SharePointServerSubscriptionEdition"))
            {
