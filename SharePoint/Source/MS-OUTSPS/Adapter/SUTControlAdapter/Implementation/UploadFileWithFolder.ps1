#---------------------------------------------------------------------------------
# Purpose: Upload a file to specified folder under specified Document Library.
#---------------------------------------------------------------------------------
...
} -argumentlist $documentLibraryTitle, $requestUrl, $transportType, $fileName, $subfolderName
