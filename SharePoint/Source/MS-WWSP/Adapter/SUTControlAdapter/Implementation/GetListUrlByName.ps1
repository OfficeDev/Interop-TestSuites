...
$ret = invoke-command -computer $computerName -Credential $credential -scriptblock {
  ...
  try
  {
      ...
      if($specifiedDoclibrary.ParentWebUrl -eq "/")
      {
          $listUrl = $transportType + "://" + $spSites.HostName + "/" + $listName
      }
      else
      {
         $listUrl = $transportType + "://" + $spSites.HostName + $specifiedDoclibrary.ParentWebUrl + "/" + $listName
      }
  ...
  return $ret
} -argumentlist $listName, $requestUrl, $transportType
