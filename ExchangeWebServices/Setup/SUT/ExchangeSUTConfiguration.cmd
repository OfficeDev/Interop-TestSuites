...
if %powershellExist% equ 1 (PowerShell.exe -ExecutionPolicy ByPass .\ExchangeSUTConfiguration.ps1) else (echo PowerShell is not installed, you should install it first.)
Pause