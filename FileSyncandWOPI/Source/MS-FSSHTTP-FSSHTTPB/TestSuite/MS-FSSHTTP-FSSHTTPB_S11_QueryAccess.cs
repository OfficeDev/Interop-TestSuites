...
namespace Microsoft.Protocols.TestSuites.MS_FSSHTTP_FSSHTTPB
{
    ...
    /// <summary>
    /// A class which contains test cases used to verify the QueryAccess sub request operation.
    /// </summary>
    [TestClass]
    public sealed class MS_FSSHTTP_FSSHTTPB_S11_QueryAccess : S11_QueryAccess
    {
        ...
        {
            S11_QueryAccess.ClassInitialize(testContext);
        }
