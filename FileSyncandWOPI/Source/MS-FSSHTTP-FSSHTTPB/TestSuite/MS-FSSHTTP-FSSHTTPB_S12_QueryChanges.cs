...
namespace Microsoft.Protocols.TestSuites.MS_FSSHTTP_FSSHTTPB
{
    ...
    /// <summary>
    /// A class which contains test cases used to verify the QueryChanges sub request operation.
    /// </summary>
    [TestClass]
    public sealed class MS_FSSHTTP_FSSHTTPB_S12_QueryChanges : S12_QueryChanges
    {
        ...
        {
            S12_QueryChanges.ClassInitialize(testContext);
        }
