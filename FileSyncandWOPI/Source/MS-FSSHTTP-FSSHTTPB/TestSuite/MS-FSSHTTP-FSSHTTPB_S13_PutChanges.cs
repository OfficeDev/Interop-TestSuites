namespace Microsoft.Protocols.TestSuites.MS_FSSHTTP_FSSHTTPB
{
    ...
    /// <summary>
    /// A class which contains test cases used to verify the PutChanges sub request operation.
    /// </summary>
    [TestClass]
    public sealed class MS_FSSHTTP_FSSHTTPB_S13_PutChanges : S13_PutChanges
    {
        ...
        {
            S13_PutChanges.ClassInitialize(testContext);
        }
