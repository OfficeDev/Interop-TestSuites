namespace Microsoft.Protocols.TestSuites.MS_WOPI
{
    ...
    /// </summary>
    [TestClass]
    public class MS_WOPI_S06_ServerTime : S06_ServerTime
    {
        #region Variables
        ...
        public static void MSWOPISharedTestClassInitialize(TestContext testContext)
        {
            ...
            if (!TestSuiteHelper.VerifyRunInSupportProducts(MS_WOPI_S06_ServerTime.BaseTestSite))
            {
                return;
            }

            TestSuiteHelper.InitializeTestSuite(MS_WOPI_S06_ServerTime.BaseTestSite);
