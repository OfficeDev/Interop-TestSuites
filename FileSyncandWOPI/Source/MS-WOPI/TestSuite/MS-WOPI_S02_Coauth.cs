namespace Microsoft.Protocols.TestSuites.MS_WOPI
{
    ...
    /// </summary>
    [TestClass]
    public class MS_WOPI_S02_Coauth : S02_Coauth
    {
        #region Variables
        ...
        public static void MSWOPISharedTestClassInitialize(TestContext testContext)
        {
            ...
            if (!TestSuiteHelper.VerifyRunInSupportProducts(MS_WOPI_S02_Coauth.BaseTestSite))
            {
                return;
            }

            TestSuiteHelper.InitializeTestSuite(MS_WOPI_S02_Coauth.BaseTestSite);
