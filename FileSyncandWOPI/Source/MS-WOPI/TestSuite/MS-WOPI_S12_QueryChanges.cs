...
namespace Microsoft.Protocols.TestSuites.MS_WOPI
{
    ...
    /// </summary>
    [TestClass]
    public class MS_WOPI_S12_QueryChanges : S12_QueryChanges
    {
        #region Variables
        ...
        public static void MSWOPISharedTestClassInitialize(TestContext testContext)
        {
            ...
            if (!TestSuiteHelper.VerifyRunInSupportProducts(MS_WOPI_S12_QueryChanges.BaseTestSite))
            {
                return;
            }

            TestSuiteHelper.InitializeTestSuite(MS_WOPI_S12_QueryChanges.BaseTestSite);
