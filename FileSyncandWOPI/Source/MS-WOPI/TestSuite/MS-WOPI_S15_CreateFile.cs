...
namespace Microsoft.Protocols.TestSuites.MS_WOPI
{
    ...
    /// </summary>
    [TestClass]
    public class MS_WOPI_S15_CreateFile : S15_CreateFile
    {
        #region Variables
        ...
        public static void MSWOPISharedTestClassInitialize(TestContext testContext)
        {
            ...
            if (!TestSuiteHelper.VerifyRunInSupportProducts(MS_WOPI_S15_CreateFile.BaseTestSite))
            {
                return;
            }

            TestSuiteHelper.InitializeTestSuite(MS_WOPI_S15_CreateFile.BaseTestSite);
        ...
        protected override void InitializeContext(string requestFileUrl, string userName, string password, string domain)
        {
            ...
            TestSuiteHelper.InitializeContextForShare(requestFileUrl, userName, password, domain, CellStoreOperationType.RelativeAdd, this.Site);
        }
