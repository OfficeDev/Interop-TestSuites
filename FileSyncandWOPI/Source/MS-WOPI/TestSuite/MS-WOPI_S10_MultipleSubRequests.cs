...
namespace Microsoft.Protocols.TestSuites.MS_WOPI
{
    ...
    /// </summary>
    [TestClass]
    public class MS_WOPI_S10_MultipleSubRequests : S10_MultipleSubRequests
    {
        #region Variables
        ...
        public static void MSWOPISharedTestClassInitialize(TestContext testContext)
        {
            ...
            if (!TestSuiteHelper.VerifyRunInSupportProducts(MS_WOPI_S10_MultipleSubRequests.BaseTestSite))
            {
                return;
            }

            TestSuiteHelper.InitializeTestSuite(MS_WOPI_S10_MultipleSubRequests.BaseTestSite);
