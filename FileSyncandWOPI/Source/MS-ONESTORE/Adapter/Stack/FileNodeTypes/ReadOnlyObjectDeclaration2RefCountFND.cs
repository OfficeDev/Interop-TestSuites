namespace Microsoft.Protocols.TestSuites.MS_ONESTORE
{
    ...
    /// <summary>
    /// This class is used to represent the ReadOnlyObjectDeclaration2RefCountFND structure.
    /// </summary>
    public class ReadOnlyObjectDeclaration2RefCountFND : FileNodeBase
    {
        /// <summary>
        ...
        /// </summary>
        public ObjectDeclaration2RefCountFND Base { get; set; }
        ...
        /// <summary>
        /// This method is used to deserialize the ReadOnlyObjectDeclaration2RefCountFND object from the specified byte array and start index.
        /// </summary>
        /// <param name="byteArray">Specify the byte array.</param>
        /// <param name="startIndex">Specify the start index from the byte array.</param>
        /// <returns>Return the length in byte of the ReadOnlyObjectDeclaration2RefCountFND object.</returns>
        public override int DoDeserializeFromByteArray(byte[] byteArray, int startIndex)
        {
            int index = startIndex;
            this.Base = new ObjectDeclaration2RefCountFND(this.stpFormat, this.cbFormat);
