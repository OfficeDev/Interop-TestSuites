...
if %powershellExist% equ 1 (PowerShell.exe -ExecutionPolicy ByPass .\ExchangeClientConfiguration.ps1 '%unattendedXML%') else (echo PowerShell is not installed, you should install it first.)
