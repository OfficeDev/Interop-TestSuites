    ...
    public class S02_ModifyFolderPermissions : TestSuiteBase
    {
        ...
        public void MSOXCPERM_S02_TC02_VerifyFolderPermissions()
        {
            ...
            this.Site.CaptureRequirementIfIsTrue(
                permissionList.Contains(PermissionTypeEnum.ReadAny),
                87,
                @"[In PidTagMemberRights Property] The PidTagMemberRights property ([MS-OXPROPS] section 2.784) specifies the folder permissions that are granted to the specified user.");
