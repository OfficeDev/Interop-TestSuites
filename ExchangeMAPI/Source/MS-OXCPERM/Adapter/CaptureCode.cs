    ...
    public partial class MS_OXCPERMAdapter : ManagedAdapterBase
    {
        ...
        private void VerifyProperties(bool succeedToParse, List<PermissionUserInfo> permissionUserList)
        {
            ...
            Site.CaptureRequirementIfIsTrue(
                isVerifyR74,
                74,
                @"[In PidTagMemberId Property] The PidTagMemberId property ([MS-OXPROPS] section 2.776) specifies the unique identifier that the server generates for each user.");
