...
namespace Microsoft.Protocols.TestSuites.MS_OXCTABL {
    ...
    public partial class S02_RowRops_FindRowNotSupported_TestSuite : PtfTestClassBase {
        
        public S02_RowRops_FindRowNotSupported_TestSuite() {
...
;
        ...
        private void MSOXCTABL_S02_RowRops_FindRowNotSupported_TestSuiteCheckMAPIHTTPTransportSupportedChecker(bool isSupported) {
            this.Manager.Comment("checking step \'return CheckMAPIHTTPTransportSupported/[out False]\'");
            TestManagerHelpers.AssertAreEqual<bool>(this.Manager, false, isSupported, "isSupported of CheckMAPIHTTPTransportSupported, state S1");
        }
        
        private void MSOXCTABL_S02_RowRops_FindRowNotSupported_TestSuiteCheckMAPIHTTPTransportSupportedChecker1(bool isSupported) {
            this.Manager.Comment("checking step \'return CheckMAPIHTTPTransportSupported/[out True]\'");
            TestManagerHelpers.AssertAreEqual<bool>(this.Manager, true, isSupported, "isSupported of CheckMAPIHTTPTransportSupported, state S1");
        }
        
        private void MSOXCTABL_S02_RowRops_FindRowNotSupported_TestSuiteCheckRequirementEnabledChecker(bool enabled) {
        ...
        private void MSOXCTABL_S02_RowRops_FindRowNotSupported_TestSuiteCheckRequirementEnabledChecker1(bool enabled) {
...
;
        ...
        private void MSOXCTABL_S02_RowRops_FindRowNotSupported_TestSuite1CheckRequirementEnabledChecker(bool enabled) {
            this.Manager.Comment("checking step \'return CheckRequirementEnabled/[out True]\'");
        ...
        private void MSOXCTABL_S02_RowRops_FindRowNotSupported_TestSuite1CheckMAPIHTTPTransportSupportedChecker1(bool isSupported) {
            this.Manager.Comment("checking step \'return CheckMAPIHTTPTransportSupported/[out False]\'");
