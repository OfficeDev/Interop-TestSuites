...
namespace Microsoft.Protocols.TestSuites.MS_OXCTABL {
    ...
    public partial class S01_ColumnRops_SetColumnsecInvalidParam_TestSuite : PtfTestClassBase {
        
        public S01_ColumnRops_SetColumnsecInvalidParam_TestSuite() {
        ...
        public void MSOXCTABL_S01_ColumnRops_SetColumnsecInvalidParam_TestSuite() {
            this.Manager.BeginTest("MSOXCTABL_S01_ColumnRops_SetColumnsecInvalidParam_TestSuite");
            ...
            int temp2 = this.Manager.ExpectReturn(this.QuiescenceTimeout, true, new ExpectedReturn(S01_ColumnRops_SetColumnsecInvalidParam_TestSuite.CheckMAPIHTTPTransportSupportedInfo, null, new CheckMAPIHTTPTransportSupportedDelegate1(this.MSOXCTABL_S01_ColumnRops_SetColumnsecInvalidParam_TestSuiteCheckMAPIHTTPTransportSupportedChecker)), new ExpectedReturn(S01_ColumnRops_SetColumnsecInvalidParam_TestSuite.CheckMAPIHTTPTransportSupportedInfo, null, new CheckMAPIHTTPTransportSupportedDelegate1(this.MSOXCTABL_S01_ColumnRops_SetColumnsecInvalidParam_TestSuiteCheckMAPIHTTPTransportSupportedChecker1)));
            if ((temp2 == 0)) {
...
;
        ...
        private void MSOXCTABL_S01_ColumnRops_SetColumnsecInvalidParam_TestSuiteCheckMAPIHTTPTransportSupportedChecker(bool isSupported) {
