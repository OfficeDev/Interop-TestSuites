...
namespace Microsoft.Protocols.TestSuites.MS_OXCTABL {
    ...
    public partial class S06_RestrictRop_RestrictNotSupported_TestSuite : PtfTestClassBase {
        
        public S06_RestrictRop_RestrictNotSupported_TestSuite() {
...
;
        ...
        private void MSOXCTABL_S06_RestrictRop_RestrictNotSupported_TestSuiteCheckMAPIHTTPTransportSupportedChecker(bool isSupported) {
            this.Manager.Comment("checking step \'return CheckMAPIHTTPTransportSupported/[out False]\'");
            TestManagerHelpers.AssertAreEqual<bool>(this.Manager, false, isSupported, "isSupported of CheckMAPIHTTPTransportSupported, state S1");
        }
        
        private void MSOXCTABL_S06_RestrictRop_RestrictNotSupported_TestSuiteCheckMAPIHTTPTransportSupportedChecker1(bool isSupported) {
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        public void MSOXCTABL_S06_RestrictRop_RestrictNotSupported_TestSuite1() {
            this.Manager.BeginTest("MSOXCTABL_S06_RestrictRop_RestrictNotSupported_TestSuite1");
            ...
            int temp5 = this.Manager.ExpectReturn(this.QuiescenceTimeout, true, new ExpectedReturn(S06_RestrictRop_RestrictNotSupported_TestSuite.CheckMAPIHTTPTransportSupportedInfo, null, new CheckMAPIHTTPTransportSupportedDelegate1(this.MSOXCTABL_S06_RestrictRop_RestrictNotSupported_TestSuite1CheckMAPIHTTPTransportSupportedChecker)), new ExpectedReturn(S06_RestrictRop_RestrictNotSupported_TestSuite.CheckMAPIHTTPTransportSupportedInfo, null, new CheckMAPIHTTPTransportSupportedDelegate1(this.MSOXCTABL_S06_RestrictRop_RestrictNotSupported_TestSuite1CheckMAPIHTTPTransportSupportedChecker1)));
            if ((temp5 == 0)) {
                ...
                this.Manager.Comment("executing step \'call RopRestrict(1,True,False,False)\'");
                temp4 = this.IMS_OXCTABLAdapterInstance.RopRestrict(1u, true, false, false);
                this.Manager.Checkpoint("MS-OXCTABL_R461");
                this.Manager.Comment("reaching state \'S13\'");
                this.Manager.Comment("checking step \'return RopRestrict/ecNotSupported\'");
                TestManagerHelpers.AssertAreEqual<Microsoft.Protocols.TestSuites.MS_OXCTABL.TableRopReturnValues>(this.Manager, Microsoft.Protocols.TestSuites.MS_OXCTABL.TableRopReturnValues.ecNotSupported, temp4, "return of RopRestrict, state S13");
...
;
        ...
        private void MSOXCTABL_S06_RestrictRop_RestrictNotSupported_TestSuite1CheckMAPIHTTPTransportSupportedChecker(bool isSupported) {
            this.Manager.Comment("checking step \'return CheckMAPIHTTPTransportSupported/[out True]\'");
