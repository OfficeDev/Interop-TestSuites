...
namespace Microsoft.Protocols.TestSuites.MS_OXCTABL {
    ...
    public partial class S07_AsyncRops_SortTableAsynchronous_TestSuite : PtfTestClassBase {
        
        public S07_AsyncRops_SortTableAsynchronous_TestSuite() {
        ...
        public void MSOXCTABL_S07_AsyncRops_SortTableAsynchronous_TestSuite() {
            this.Manager.BeginTest("MSOXCTABL_S07_AsyncRops_SortTableAsynchronous_TestSuite");
            ...
            int temp3 = this.Manager.ExpectReturn(this.QuiescenceTimeout, true, new ExpectedReturn(S07_AsyncRops_SortTableAsynchronous_TestSuite.CheckMAPIHTTPTransportSupportedInfo, null, new CheckMAPIHTTPTransportSupportedDelegate1(this.MSOXCTABL_S07_AsyncRops_SortTableAsynchronous_TestSuiteCheckMAPIHTTPTransportSupportedChecker)), new ExpectedReturn(S07_AsyncRops_SortTableAsynchronous_TestSuite.CheckMAPIHTTPTransportSupportedInfo, null, new CheckMAPIHTTPTransportSupportedDelegate1(this.MSOXCTABL_S07_AsyncRops_SortTableAsynchronous_TestSuiteCheckMAPIHTTPTransportSupportedChecker1)));
            if ((temp3 == 0)) {
            ...
            if ((temp3 == 1)) {
                ...
                this.Manager.Comment("executing step \'call RopSortTable(1,True,False,False,True,False,False,True)\'");
                temp2 = this.IMS_OXCTABLAdapterInstance.RopSortTable(1u, true, false, false, true, false, false, true);
...
;
        ...
        private void MSOXCTABL_S07_AsyncRops_SortTableAsynchronous_TestSuiteCheckMAPIHTTPTransportSupportedChecker(bool isSupported) {
