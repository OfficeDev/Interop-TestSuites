...
namespace Microsoft.Protocols.TestSuites.MS_OXCTABL {
    ...
    public partial class S01_ColumnRops_SetColumnsSuccess_TestSuite : PtfTestClassBase {
        
        public S01_ColumnRops_SetColumnsSuccess_TestSuite() {
        ...
        public void MSOXCTABL_S01_ColumnRops_SetColumnsSuccess_TestSuite() {
            this.Manager.BeginTest("MSOXCTABL_S01_ColumnRops_SetColumnsSuccess_TestSuite");
            ...
            int temp2 = this.Manager.ExpectReturn(this.QuiescenceTimeout, true, new ExpectedReturn(S01_ColumnRops_SetColumnsSuccess_TestSuite.CheckMAPIHTTPTransportSupportedInfo, null, new CheckMAPIHTTPTransportSupportedDelegate1(this.MSOXCTABL_S01_ColumnRops_SetColumnsSuccess_TestSuiteCheckMAPIHTTPTransportSupportedChecker)), new ExpectedReturn(S01_ColumnRops_SetColumnsSuccess_TestSuite.CheckMAPIHTTPTransportSupportedInfo, null, new CheckMAPIHTTPTransportSupportedDelegate1(this.MSOXCTABL_S01_ColumnRops_SetColumnsSuccess_TestSuiteCheckMAPIHTTPTransportSupportedChecker1)));
            if ((temp2 == 0)) {
...
;
        ...
        private void MSOXCTABL_S01_ColumnRops_SetColumnsSuccess_TestSuiteCheckMAPIHTTPTransportSupportedChecker(bool isSupported) {
            this.Manager.Comment("checking step \'return CheckMAPIHTTPTransportSupported/[out False]\'");
            TestManagerHelpers.AssertAreEqual<bool>(this.Manager, false, isSupported, "isSupported of CheckMAPIHTTPTransportSupported, state S1");
        }
        
        private void MSOXCTABL_S01_ColumnRops_SetColumnsSuccess_TestSuiteCheckMAPIHTTPTransportSupportedChecker1(bool isSupported) {
