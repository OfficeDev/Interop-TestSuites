...
namespace Microsoft.Protocols.TestSuites.MS_OXCTABL
{
    ...
    /// </summary>
    public class ContentRestrictions : IRestrictions
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the ContentRestrictions class.
        /// </summary>
        ...
        public int Size()
        {
            int size = sizeof(RestrictionType)
                + sizeof(FuzzyLevelLowValue)
                + sizeof(FuzzyLevelHighValue)
                + sizeof(uint)
                + sizeof(uint) + this.TaggedValue.Value.Length;
