...
namespace Microsoft.Protocols.TestSuites.Common
{
    ...
    /// <summary>
    /// RopDeletePropertiesNoReplicate request buffer structure.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct RopDeletePropertiesNoReplicateRequest : ISerializable
    {
        /// <summary>
        /// Unsigned 8-bit integer. This value specifies the type of remote operation. 
        /// For this operation, this field is set to 0x7A.
        /// </summary>
        public byte RopId;
        ...
        public byte[] Serialize()
        {
            ...
            for (int i = 0; i < this.PropertyTagCount; i++)
            {
                ...
                Context.Instance.Properties.Add(new Property((PropertyType)this.PropertyTags[i].PropertyType));
    ...
    /// <summary>
    /// RopDeletePropertiesNoReplicate response buffer structure.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct RopDeletePropertiesNoReplicateResponse : IDeserializable
    {
        /// <summary>
        /// Unsigned 8-bit integer. This value specifies the type of remote operation. 
        /// For this operation, this field is set to 0x7A.
