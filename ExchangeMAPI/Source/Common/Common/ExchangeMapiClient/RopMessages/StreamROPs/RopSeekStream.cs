...
namespace Microsoft.Protocols.TestSuites.Common
{
    ...
    /// <summary>
    /// RopSeekStream request buffer structure.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct RopSeekStreamRequest : ISerializable
    {
        /// <summary>
        ...
        /// <summary>
        /// 8-bit enumeration. The possible values for this enumeration are specified in [MS-OXCPRPT]. 
        /// This value specifies the origin location for the seek operation.
        /// </summary>
        public byte Origin;

        /// <summary>
        /// 64-bit integer. This value specifies the seek offset.
        /// </summary>
        public ulong Offset;
    ...
    /// <summary>
    /// RopSeekStream response buffer structure.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct RopSeekStreamResponse : IDeserializable
    {
        /// <summary>
        /// Unsigned 8-bit integer. This value specifies the type of remote operation. 
        /// For this operation, this field is set to 0x2E.
        ...
        public int Deserialize(byte[] ropBytes, int startIndex)
        {
            ...
            {
                this.NewPosition = (ulong)BitConverter.ToInt64(ropBytes, index);
                index += sizeof(ulong);
            }
