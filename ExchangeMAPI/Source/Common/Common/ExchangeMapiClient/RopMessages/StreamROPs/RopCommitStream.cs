namespace Microsoft.Protocols.TestSuites.Common
{
    ...
    /// <summary>
    /// RopCommitStream request buffer structure.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct RopCommitStreamRequest : ISerializable
    {
        /// <summary>
        /// Unsigned 8-bit integer. This value specifies the type of remote operation. 
        /// For this operation, this field is set to 0x5D.
        /// </summary>
        public byte RopId;
    ...
    /// <summary>
    /// RopCommitStream response buffer structure.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct RopCommitStreamResponse : IDeserializable
    {
        /// <summary>
        /// Unsigned 8-bit integer. This value specifies the type of remote operation. 
        /// For this operation, this field is set to 0x5D.
        ...
        public int Deserialize(byte[] ropBytes, int startIndex)
        {
            ...
            try
            {
                ...
                this = (RopCommitStreamResponse)Marshal.PtrToStructure(responseBuffer, typeof(RopCommitStreamResponse));
                return Marshal.SizeOf(this);
            }
            finally
            {
