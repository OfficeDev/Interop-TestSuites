namespace Microsoft.Protocols.TestSuites.Common
{
    ...
    /// <summary>
    /// RopLockRegionStream request buffer structure.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct RopLockRegionStreamRequest : ISerializable
    {
        /// <summary>
        /// Unsigned 8-bit integer. This value specifies the type of remote operation. 
        /// For this operation, this field is set to 0x5B.
        /// </summary>
        public byte RopId;
    ...
    /// <summary>
    /// RopLockRegionStream response buffer structure.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct RopLockRegionStreamResponse : IDeserializable
    {
        /// <summary>
        /// Unsigned 8-bit integer. This value specifies the type of remote operation. 
        /// For this operation, this field is set to 0x5B.
        ...
        public int Deserialize(byte[] ropBytes, int startIndex)
        {
            ...
            try
            {
                ...
                this = (RopLockRegionStreamResponse)Marshal.PtrToStructure(responseBuffer, typeof(RopLockRegionStreamResponse));
                return Marshal.SizeOf(this);
            }
            finally
            {
