...
namespace Microsoft.Protocols.TestSuites.Common
{
    ...
    /// <summary>
    /// RopCollapseRow request buffer structure.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct RopCollapseRowRequest : ISerializable
    {
        /// <summary>
        /// Unsigned 8-bit integer. This value specifies the type of remote operation. 
        /// For this operation, this field is set to 0x5A.
        /// </summary>
        public byte RopId;
        ...
        /// <summary>
        /// 64-bit identifier. This identifier specifies the category to be collapsed.
        /// </summary>
    ...
    /// <summary>
    /// RopCollapseRow response buffer structure.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct RopCollapseRowResponse : IDeserializable
    {
        /// <summary>
        /// Unsigned 8-bit integer. This value specifies the type of remote operation. 
        /// For this operation, this field is set to 0x5A.
        ...
        /// <summary>
        /// Unsigned 32-bit integer. This value specifies the total number of rows in the collapsed category.
        /// </summary>
        ...
        public int Deserialize(byte[] ropBytes, int startIndex)
        {
            ...
            {
                this.CollapsedRowCount = (uint)BitConverter.ToInt32(ropBytes, index);
                index += sizeof(uint);
            }
