namespace Microsoft.Protocols.TestSuites.Common
{
    ...
    /// <summary>
    /// RopResetTable request buffer structure.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct RopResetTableRequest : ISerializable
    {
        /// <summary>
        /// Unsigned 8-bit integer. This value specifies the type of remote operation. 
        /// For this operation, this field is set to 0x81.
        /// </summary>
        public byte RopId;
    ...
    /// <summary>
    /// RopResetTable response buffer structure.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct RopResetTableResponse : IDeserializable
    {
        /// <summary>
        /// Unsigned 8-bit integer. This value specifies the type of remote operation. 
        /// For this operation, this field is set to 0x81.
        ...
        public int Deserialize(byte[] ropBytes, int startIndex)
        {
            ...
            try
            {
                ...
                this = (RopResetTableResponse)Marshal.PtrToStructure(responseBuffer, typeof(RopResetTableResponse));
                return Marshal.SizeOf(this);
            }
            finally
            {
