...
namespace Microsoft.Protocols.TestSuites.Common
{
    ...
    /// <summary>
    /// RopQueryPosition request buffer structure.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct RopQueryPositionRequest : ISerializable
    {
        /// <summary>
        /// Unsigned 8-bit integer. This value specifies the type of remote operation. 
        /// For this operation, this field is set to 0x17.
        /// </summary>
        public byte RopId;
    ...
    /// <summary>
    /// RopQueryPosition response buffer structure.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct RopQueryPositionResponse : IDeserializable
    {
        /// <summary>
        /// Unsigned 8-bit integer. This value specifies the type of remote operation. 
        /// For this operation, this field is set to 0x17.
        ...
        /// <summary>
        /// Unsigned 32-bit integer. This value represents the numerator of the fraction identifying the table position.
        /// </summary>
        public uint Numerator;

        /// <summary>
        /// Unsigned 32-bit integer. This value represents the denominator of the fraction identifying the table position.
        /// </summary>
        ...
        public int Deserialize(byte[] ropBytes, int startIndex)
        {
            ...
            {
                this.Numerator = (uint)BitConverter.ToInt32(ropBytes, index);
                index += sizeof(uint);
                this.Denominator = (uint)BitConverter.ToInt32(ropBytes, index);
                index += sizeof(uint);
            }
