...
namespace Microsoft.Protocols.TestSuites.Common
{
    ...
    /// <summary>
    /// RopSeekRowFractional request buffer structure.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct RopSeekRowFractionalRequest : ISerializable
    {
        /// <summary>
        /// Unsigned 8-bit integer. This value specifies the type of remote operation. 
        /// For this operation, this field is set to 0x1A.
        /// </summary>
        public byte RopId;
        ...
        /// <summary>
        /// Unsigned 32-bit integer. This value represents the numerator of the fraction identifying the table position to seek to.
        /// </summary>
        public uint Numerator;

        /// <summary>
        /// Unsigned 32-bit integer. This value represents the denominator of the fraction identifying the table position to seek to.
        /// </summary>
    ...
    /// <summary>
    /// RopSeekRowFractional response buffer structure.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct RopSeekRowFractionalResponse : IDeserializable
    {
        /// <summary>
        /// Unsigned 8-bit integer. This value specifies the type of remote operation. 
        /// For this operation, this field is set to 0x1A.
        ...
        public int Deserialize(byte[] ropBytes, int startIndex)
        {
            ...
            try
            {
                ...
                this = (RopSeekRowFractionalResponse)Marshal.PtrToStructure(responseBuffer, typeof(RopSeekRowFractionalResponse));
                return Marshal.SizeOf(this);
            }
            finally
            {
