...
namespace Microsoft.Protocols.TestSuites.Common
{
    ...
    /// <summary>
    /// RopSpeelerLockMessage request buffer structure.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct RopSpoolerLockMessageRequest : ISerializable
    {
        /// <summary>
        /// Unsigned 8-bit integer. This value specifies the type of remote operation. 
        /// For this operation, this field is set to 0x48.
        /// </summary>
        public byte RopId;
        ...
        /// <summary>
        /// 8-bit enumeration. The possible values for this enumeration are specified in [MS-OXOMSG].
        /// </summary>
    ...
    /// <summary>
    /// RopSpoolerLockMessage response buffer structure.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct RopSpoolerLockMessageResponse : IDeserializable
    {
        /// <summary>
        /// Unsigned 8-bit integer. This value specifies the type of remote operation. 
        /// For this operation, this field is set to 0x48.
        ...
        public int Deserialize(byte[] ropBytes, int startIndex)
        {
            ...
            try
            {
                ...
                this = (RopSpoolerLockMessageResponse)Marshal.PtrToStructure(responseBuffer, typeof(RopSpoolerLockMessageResponse));
                return Marshal.SizeOf(this);
            }
            finally
            {
