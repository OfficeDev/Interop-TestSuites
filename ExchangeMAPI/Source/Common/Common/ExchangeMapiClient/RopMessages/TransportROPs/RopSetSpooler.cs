namespace Microsoft.Protocols.TestSuites.Common
{
    ...
    /// <summary>
    /// RopSetSpooler request buffer structure.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct RopSetSpoolerRequest : ISerializable
    {
        /// <summary>
        /// Unsigned 8-bit integer. This value specifies the type of remote operation. 
        /// For this operation, this field is set to 0x47.
        /// </summary>
        public byte RopId;
    ...
    /// <summary>
    /// RopSetSpooler response buffer structure.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct RopSetSpoolerResponse : IDeserializable
    {
        /// <summary>
        /// Unsigned 8-bit integer. This value specifies the type of remote operation. 
        /// For this operation, this field is set to 0x47.
        ...
        public int Deserialize(byte[] ropBytes, int startIndex)
        {
            ...
            try
            {
                ...
                this = (RopSetSpoolerResponse)Marshal.PtrToStructure(responseBuffer, typeof(RopSetSpoolerResponse));
                return Marshal.SizeOf(this);
            }
            finally
            {
