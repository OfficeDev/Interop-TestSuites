...
namespace Microsoft.Protocols.TestSuites.Common
{
    ...
    /// <summary>
    /// RopAbortSubmit request buffer structure.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct RopAbortSubmitRequest : ISerializable
    {
        /// <summary>
        /// Unsigned 8-bit integer. This value specifies the type of remote operation. 
        /// For this operation, this field is set to 0x34.
        /// </summary>
        public byte RopId;
        ...
        /// <summary>
        /// 64-bit identifier. This value identifies the folder in which the submitted message is located.
        /// </summary>
        public ulong FolderId;

        /// <summary>
        /// 64-bit identifier. This value identifies the submitted message.
        /// </summary>
    ...
    /// <summary>
    /// RopAbortSubmit response buffer structure.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct RopAbortSubmitResponse : IDeserializable
    {
        /// <summary>
        /// Unsigned 8-bit integer. This value specifies the type of remote operation. 
        /// For this operation, this field is set to 0x34.
        ...
        public int Deserialize(byte[] ropBytes, int startIndex)
        {
            ...
            try
            {
                ...
                this = (RopAbortSubmitResponse)Marshal.PtrToStructure(responseBuffer, typeof(RopAbortSubmitResponse));
                return Marshal.SizeOf(this);
            }
            finally
            {
