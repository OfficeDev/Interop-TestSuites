        ...
        public void MSOXCFOLD_S05_TC01_CreateFolderNoCreateSubfolderPermission()
        {
            ...
            if (Common.IsRequirementEnabled(106601, this.Site))
            {
                ...
                Site.CaptureRequirementIfAreEqual<uint>(
                    ...
                    createFolderResponse.ReturnValue,
                    106601,
                    @"[In Appendix A: Product Behavior] Implementation returns ecAccessdenied if the client does not have permissions to create the folder. <13> Section 3.2.5.2: Exchange 2007, Exchange 2013, Exchange 2016 and Exchange 2019 Preview return ecAccessdenied.");
