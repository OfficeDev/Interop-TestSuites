namespace Microsoft.Protocols.TestSuites.MS_OXCFOLD
{
    ...
    public class S03_FolderInformation : TestSuiteBase
    {
        ...
        public void MSOXCFOLD_S03_TC08_SetAndGetProperties()
        {
            ...
            Site.CaptureRequirement(
                10356,
                @"[In PidTagAttributeHidden Property] The PidTagAttributeHidden property ([MS-OXPROPS] section 2.611) specifies whether the folder is hidden.");
        ...
        public void MSOXCFOLD_S03_TC16_GetPropertyPidTagFolderFlags()
        {
            ...
            // Add the debug information
            Site.Log.Add(LogEntryKind.Debug, @"Verify MS-OXCFOLD_R1035110: [In PidTagFolderFlags Property] The PidTagFolderId property ([MS-OXPROPS] section 2.701) contains a computed value that specifies the type or state of a folder.");

            // Verify MS-OXCFOLD requirement: MS-OXCFOLD_R1035110
            Site.CaptureRequirement(
                1035110,
                @"[In PidTagFolderFlags Property] The PidTagFolderId property ([MS-OXPROPS] section 2.701) contains a computed value that specifies the type or state of a folder.");
