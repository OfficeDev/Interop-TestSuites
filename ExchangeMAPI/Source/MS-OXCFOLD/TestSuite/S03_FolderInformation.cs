    ...
    public class S03_FolderInformation : TestSuiteBase
    {
        ...
        public void MSOXCFOLD_S03_TC07_GetReadOnlyProperties()
        {
            ...
            Site.CaptureRequirementIfAreNotEqual<uint>(
                ...
                pidTagMessageSize,
                10353,
                @"[In PidTagMessageSize Property] The PidTagMessageSize property ([MS-OXPROPS] section 2.792) specifies the aggregate size of messages in the folder.");
            ...
            Site.CaptureRequirementIfAreEqual<uint>(
                ...
                10347,
                @"[In PidTagContentUnreadCount Property] The PidTagContentUnreadCount property ([MS-OXPROPS] section 2.644) specifies the number of unread messages in a folder, as computed by the message store.");
            ...
            Site.CaptureRequirementIfAreEqual<ulong>(
                ...
                10351,
                @"[In PidTagFolderId Property] The PidTagFolderId property ([MS-OXPROPS] section 2.696) contains a FID structure ([MS-OXCDATA] section 2.2.1.1) that uniquely identifies a folder.");
            ...
            this.Site.CaptureRequirementIfAreEqual<uint>(
                ...
                3006,
                @"[In PidTagDeletedCountTotal Property] The PidTagDeletedCountTotal property ([MS-OXPROPS] section 2.665) specifies the total number of messages that have been deleted from a folder, excluding messages that have been deleted from the folder's subfolders.");
            ...
            this.Site.CaptureRequirementIfIsTrue(
                ...
                352002,
                @"[In PidTagHierRev Property] The PidTagHierRev property ([MS-OXPROPS] section 2.717) specifies the time, in Coordinated Universal Time (UTC), to trigger the client in cached mode to synchronize the folder hierarchy.");
            #endregion
            ...
            Site.CaptureRequirement(
                10355,
                @"[In PidTagSubfolders Property] The PidTagSubfolders property ([MS-OXPROPS] section 2.1028) specifies whether the folder has any subfolders.");
            ...
            Site.CaptureRequirementIfIsTrue(
                ...
                10028,
                @"[In PidTagHierarchyChangeNumber Property] The PidTagHierarchyChangeNumber property ([MS-OXPROPS] section 2.716) specifies the number of subfolders in the folder.");
        ...
        public void MSOXCFOLD_S03_TC08_SetAndGetProperties()
        {
            ...
            Site.CaptureRequirementIfAreEqual<string>(
                ...
                10359,
                @"[In PidTagComment Property] The PidTagComment property ([MS-OXPROPS] section 2.633) contains a comment about the purpose or content of the folder.");
            ...
            Site.CaptureRequirement(
                10356,
                @"[In PidTagAttributeHidden Property] The PidTagAttributeHidden property ([MS-OXPROPS] section 2.607) specifies whether the folder is hidden.");
        ...
        public void MSOXCFOLD_S03_TC11_RopSetSearchCriteriaFailure()
        {
            ...
            if (Common.IsRequirementEnabled(116001, this.Site))
            {
                ...
                Site.CaptureRequirementIfAreEqual<uint>(
                    ...
                    setSearchCriteriaResponse.ReturnValue,
                    116001,
                    @"[In Appendix A: Product Behavior] If the client sets an invalid bit in the SearchFlags field, implementation does fail the RopSetSearchCriteria ROP operation with ecInvalidParam (0x80070057). (Microsoft Exchange 2010, Microsoft Exchange 2013 and Microsoft Exchange 2016 follow this behavior.)");
            ...
            if (Common.IsRequirementEnabled(116003, this.Site))
            {
                // Add the debug information
                ...
                Site.CaptureRequirementIfAreNotEqual<uint>(
                    ...
                    setSearchCriteriaResponse.ReturnValue,
                    116003,
                    @"[In Appendix A: Product Behavior] If the client sets an invalid bit in the SearchFlags field, implementation does fail the RopSetSearchCriteria ROP operation with a ecNotSupported error code. (&lt;19&gt; Section 3.2.5.4: Exchange 2019 returns a ecNotSupported error code.)");
            }
            #endregion
        ...
        public void MSOXCFOLD_S03_TC16_GetPropertyPidTagFolderFlags()
        {
            ...
            Site.CaptureRequirement(
                1035110,
                @"[In PidTagFolderFlags Property] The PidTagFolderId property ([MS-OXPROPS] section 2.697) contains a computed value that specifies the type or state of a folder.");
