namespace Microsoft.Protocols.TestSuites.MS_OXCFXICS
{
    ...
    public partial class MS_OXCFXICSAdapter : ManagedAdapterBase, IMS_OXCFXICSAdapter
    {
        ...
        private void VerifyRopFastTransferDestinationPutBuffer(RopFastTransferDestinationPutBufferRequest fastTransferDestinationPutBufferRequest, object response)
        {
            ...
            else if (Common.IsRequirementEnabled(317800201, this.Site))
            {
                ...
                this.Site.CaptureRequirementIfAreEqual<ushort>(
                    ...
                    fastTransferDestinationPutBufferResponse.TotalStepCount,
                    317800201,
                    @"[In Appendix A: Product Behavior] Implementation does set this value to 0x0000. [<11> Section 2.2.3.1.2.2.2: Exchange 2007 set the value of the TotalStepCount field to 0x0000.]");
            }
        ...
        private void VerifyRopFastTransferDestinationPutBufferExtended(RopFastTransferDestinationPutBufferExtendedRequest fastTransferDestinationPutBufferExtenedRequest, object response)
        {
            ...
            if (Common.IsRequirementEnabled(318302601, this.Site))
            {
                ...
                this.Site.CaptureRequirementIfAreEqual<uint>(
                    ...
                    318302601,
                    @"[In Appendix A: Product Behavior] Implementation does set this value to 0x00000001. [&lt;14&gt; Section 2.2.3.1.2.3.2: Exchange 2010, Exchange 2013, Exchange 2016 and Exchange 2019 Preview set the value of the TotalStepCount field to 0x00000001.]");
            }
        ...
        private void VerifyValuePidTagPredecessorChangeListAndPidTagChangeKey(int serverId, int handleIndex)
        {
            ...
            using (MemoryStream memoryStream = new MemoryStream(pidTagPredecessorChangeListValue, 2, BitConverter.ToInt16(pidTagPredecessorChangeListValue, 0)))
            {
