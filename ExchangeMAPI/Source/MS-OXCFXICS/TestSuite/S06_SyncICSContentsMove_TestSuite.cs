...
namespace Microsoft.Protocols.TestSuites.MS_OXCFXICS {
    ...
    public partial class S06_SyncICSContentsMove_TestSuite : PtfTestClassBase {
        
        public S06_SyncICSContentsMove_TestSuite() {
        ...
        public void MSOXCFXICS_S06_SyncICSContentsMove_TestSuite() {
            this.Manager.BeginTest("MSOXCFXICS_S06_SyncICSContentsMove_TestSuite");
            ...
            int temp50 = this.Manager.ExpectReturn(this.QuiescenceTimeout, true, new ExpectedReturn(S06_SyncICSContentsMove_TestSuite.CheckMAPIHTTPTransportSupportedInfo, null, new CheckMAPIHTTPTransportSupportedDelegate1(this.MSOXCFXICS_S06_SyncICSContentsMove_TestSuiteCheckMAPIHTTPTransportSupportedChecker)), new ExpectedReturn(S06_SyncICSContentsMove_TestSuite.CheckMAPIHTTPTransportSupportedInfo, null, new CheckMAPIHTTPTransportSupportedDelegate1(this.MSOXCFXICS_S06_SyncICSContentsMove_TestSuiteCheckMAPIHTTPTransportSupportedChecker1)));
            if ((temp50 == 0)) {
                ...
                int temp49 = this.Manager.ExpectReturn(this.QuiescenceTimeout, true, new ExpectedReturn(S06_SyncICSContentsMove_TestSuite.CheckRequirementEnabledInfo, null, new CheckRequirementEnabledDelegate1(this.MSOXCFXICS_S06_SyncICSContentsMove_TestSuiteCheckRequirementEnabledChecker)), new ExpectedReturn(S06_SyncICSContentsMove_TestSuite.CheckRequirementEnabledInfo, null, new CheckRequirementEnabledDelegate1(this.MSOXCFXICS_S06_SyncICSContentsMove_TestSuiteCheckRequirementEnabledChecker1)));
                if ((temp49 == 0)) {
...
;
        ...
        private void MSOXCFXICS_S06_SyncICSContentsMove_TestSuiteCheckMAPIHTTPTransportSupportedChecker(bool isSupported) {
            this.Manager.Comment("checking step \'return CheckMAPIHTTPTransportSupported/[out True]\'");
            TestManagerHelpers.AssertAreEqual<bool>(this.Manager, true, isSupported, "isSupported of CheckMAPIHTTPTransportSupported, state S1");
        }
        
        private void MSOXCFXICS_S06_SyncICSContentsMove_TestSuiteCheckRequirementEnabledChecker(bool enabled) {
        ...
        private void MSOXCFXICS_S06_SyncICSContentsMove_TestSuiteCheckRequirementEnabledChecker1(bool enabled) {
        ...
        private void MSOXCFXICS_S06_SyncICSContentsMove_TestSuiteCheckMAPIHTTPTransportSupportedChecker1(bool isSupported) {
