namespace Microsoft.Protocols.TestSuites.MS_OXCRPC
{
    ...
    public class ComposeROPCommand
    {
        ...
        /// <summary>
        /// Composes the RopWriteStreamExtended Request Buffer.
        /// This ROP writes bytes to a stream. More detailed information about this operation can be found in [MS-OXCPRPT].
        /// </summary>
        /// <param name="inputServerObjectHandle">The handle for the input Server Object.</param>
        /// <returns>The rgbIn buffer generated by this method.</returns>
        public byte[] ComposeWriteStreamExtendedRequest(uint inputServerObjectHandle)
        {
            ...
            writeStreamExtendedRequest.LogonId = Convert.ToByte(0);
            writeStreamExtendedRequest.InputHandleIndex = Convert.ToByte(0);
            writeStreamExtendedRequest.DataSize = (ushort)dataToWrite.Length;
            writeStreamExtendedRequest.Data = dataToWrite;
        ...
        /// <summary>
        /// Composes the RopFastTransferDestinationConfigure Request Buffer. 
        /// </summary>
        /// <param name="inputServerObjectHandle">The handle for the input Server Object.</param>
        /// <returns>The rgbIn buffer generated by this method.</returns>
        public byte[] ComposeRopFastTransferDestinationConfigure(uint inputServerObjectHandle)
        {
            RopFastTransferDestinationConfigureRequest fastTransferDestinationConfigureRequest=new RopFastTransferDestinationConfigureRequest();
            fastTransferDestinationConfigureRequest.RopId = (byte)RopId.RopFastTransferDestinationConfigure;
            fastTransferDestinationConfigureRequest.LogonId = Convert.ToByte(0);
            fastTransferDestinationConfigureRequest.InputHandleIndex = Convert.ToByte(0);
            fastTransferDestinationConfigureRequest.OutputHandleIndex = Convert.ToByte(ConstValues.OutputHandleIndexForOneRop);
        ...
        /// <summary>
        /// Composes the RopFastTransferDestinationPutBuffer Request Buffer. 
        ...
        /// <param name="inputServerObjectHandle">The handle for the input Server Object.</param>
        /// <returns>The rgbIn buffer generated by this method.</returns>
        public byte[] ComposeRopFastTransferDestinationPutBufferRequest(uint inputServerObjectHandle)
        {
            ...
            fastTransferDestinationPutBufferRequest.LogonId = Convert.ToByte(0);
            fastTransferDestinationPutBufferRequest.InputHandleIndex = Convert.ToByte(0);
        ...
        /// <summary>
        /// Composes the RopFastTransferDestinationPutBufferExtended Request Buffer. 
        /// This ROP uploads the next portion of an input FastTransfer stream for a previously configured FastTransfer upload operation.
        /// </summary>
        /// <param name="inputServerObjectHandle">The handle for the input Server Object.</param>
        /// <returns>The rgbIn buffer generated by this method.</returns>
        public byte[] ComposeRopFastTransferDestinationPutBufferExtendedRequest(uint inputServerObjectHandle)
        {
            byte[] transferData = { 0x03, 0x00, 0x09, 0x40 };
            ...
            fastTransferDestinationPutBufferExtendedRequest.LogonId = Convert.ToByte(0);
            fastTransferDestinationPutBufferExtendedRequest.InputHandleIndex = Convert.ToByte(0);
