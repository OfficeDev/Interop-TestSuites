    ...
    public class S08_RopAttachment : TestSuiteBase
    {
        ...
        public void MSOXCMSG_S08_TC04_AttachmentObjectProperties()
        {
            ...
            this.Site.CaptureRequirementIfIsTrue(
                isVerfiedR236,
                236,
                @"[In PidTagAttachDataBinary Property] The PidTagAttachDataBinary property ([MS-OXPROPS] section 2.583) contains the contents of the file to be attached.");
        ...
        public void MSOXCMSG_S08_TC05_RopDeleteAttachmentSuccessfully()
        {
            ...
            this.Site.CaptureRequirementIfAreEqual<bool>(
                ...
                16,
                @"[In PidTagHasAttachments Property] The server computes this property [PidTagHasAttachments] from the mfHasAttach flag of the PidTagMessageFlags property ([MS-OXPROPS] section 2.785).");
            ...
            this.Site.CaptureRequirementIfIsTrue(
                isVerifiedR498,
                498,
                @"[In PidTagHasAttachments Property] The PidTagHasAttachments property ([MS-OXPROPS] section 2.710) indicates whether the Message object contains at least one attachment.");
        ...
        public void MSOXCMSG_S08_TC06_MIMEProperties()
        {
            ...
            this.Site.CaptureRequirementIfAreEqual<string>(
                ...
                604,
                @"[In PidTagAttachExtension Property] The PidTagAttachExtension property ([MS-OXPROPS] section 2.586) contains a file name extension that indicates the document type of an attachment.");
            #endregion
