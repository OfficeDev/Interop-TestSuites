    ...
    public class S02_SetMessageStatus : TestSuiteBase
    {
        ...
        public void MSOXCMSG_S02_TC01_SetAndGetMessageStatus()
        {
            ...
            this.Site.CaptureRequirementIfAreEqual<uint>(
                ...
                773,
                @"[In RopSetMessageStatus ROP] The RopSetMessageStatus ROP ([MS-OXCROPS] section 2.2.6.8) sets the PidTagMessageStatus property ([MS-OXPROPS] section 2.794) on a message in a folder without the need to open or save the Message object.");
