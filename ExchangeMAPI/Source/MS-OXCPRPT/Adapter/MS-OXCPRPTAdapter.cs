namespace Microsoft.Protocols.TestSuites.MS_OXCPRPT
{
    ...
    public partial class MS_OXCPRPTAdapter : ManagedAdapterBase, IMS_OXCPRPTAdapter
    {
        ...
        {
            if (Common.IsRequirementEnabled(30401001, this.Site))
            {
                TaggedPropertyValue[] tagPtyValues = new TaggedPropertyValue[1];
                if (this.cprptCurrentType == ServerObjectType.Folder)
                {
                ...
                this.VerifyRopWriteStreamExtended(writeStreamExtendedResponse, openFlag, WriteData, canBeRetrieval, isChangInDB, forErrorCode, isWriteSizeElemetRight);
            ...
            {
                error = CPRPTErrorCode.None;
                Site.Assert.Inconclusive("This case can not run since the implementation does not support RopWriteStreamExtended ROP.");
            }
        }
