        ...
        private void VerifyRopGetPropertiesAllForExtendedRules(RopGetPropertiesAllResponse ropGetPropertiesAllResponse)
        {
            ...
            if (isFAIMessage)
            {
                ...
                Site.CaptureRequirementIfIsNotNull(
                    ...
                    169,
                    @"[In PidTagRuleMessageSequence Property] The PidTagRuleMessageSequence property ([MS-OXPROPS] section 2.956) MUST be set on the FAI message.");
                ...
                Site.CaptureRequirementIfIsNotNull(
                    ...
                    172,
                    @"[In PidTagRuleMessageState Property] The PidTagRuleMessageState property ([MS-OXPROPS] section 2.957) MUST be set on the FAI message.");
                ...
                Site.CaptureRequirementIfIsNotNull(
                    ...
                    183,
                    @"[In PidTagRuleMessageProvider Property] The PidTagRuleMessageProvider property ([MS-OXPROPS] section 2.954) MUST be set on the FAI message.");
                ...
                Site.CaptureRequirementIfIsNotNull(
                    ...
                    190,
                    @"[In PidTagExtendedRuleMessageActions Property] The PidTagExtendedRuleMessageActions property ([MS-OXPROPS] section 2.692) MUST be set on the FAI message.");
                ...
                Site.CaptureRequirementIfIsNotNull(
                    ...
                    196,
                    @"[In PidTagExtendedRuleMessageCondition Property] The PidTagExtendedRuleMessageCondition property ([MS-OXPROPS] section 2.693) MUST be set on the FAI message.");
            }
        }
