    ...
    public class S05_GenerateDAMAndDEM : TestSuiteBase
    {
        ...
        public void MSOXORULE_S05_TC01_ServerGenerateOneDAM_ForOP_DEFER_ACTION_BelongToSameRuleProvider()
        {
            ...
            Site.CaptureRequirementIfIsTrue(
                ...
                368,
                @"[In PidTagRuleIds] The PidTagRuleIds property ([MS-OXPROPS] section 2.950) is a buffer contains the PidTagRuleId (section 2.2.1.3.1.1) value (8 bytes) from the first rules (2) that contributed actions (2) in the PidTagClientActions property (section 2.2.6.6), and repeats that value once for each rule (2) that contributed actions (2).");
            #endregion
            #endregion
        }
        ...
        public void MSOXORULE_S05_TC02_ServerGenerateSeparateDAM_ForOP_DEFER_ACTION_BelongToSeparateRuleProvider()
        {
            ...
            Site.CaptureRequirementIfIsTrue(
                isVerifyR371,
                371,
                "[In PidTagDeferredActionMessageOriginalEntryId Property] The PidTagDeferredActionMessageOriginalEntryId property ([MS-OXPROPS] section 2.661) contains the server EntryID for the DAM message on the server.");
            #endregion
        ...
        public void MSOXORULE_S05_TC05_ServerGenerateDEM_ByOP_MOVE_Error_ForActionNumberProperty()
        {
            ...
            Site.CaptureRequirementIfAreEqual<uint>(
                ...
                ruleActionNumber,
                707,
                @"[In PidTagRuleActionNumber Property] The PidTagRuleActionNumber property ([MS-OXPROPS] section 2.943) MUST be set to the zero-based index of the action (2) that failed. (For example, if specific to an action (2), a property value of 0x00000000 means that the first action (2) failed, 0x00000001 means that the second action (2) failed.)");
            ...
            Site.CaptureRequirementIfAreEqual<uint>(
                ...
                ruleActionType,
                1009,
                @"[In PidTagRuleActionType Property] The PidTagRuleActionType property ([MS-OXPROPS] section 2.945) specifies the action (2) of the rule (2) that failed.");
            #endregion
            #endregion
        ...
        public void MSOXORULE_S05_TC07_ServerGenerateOneDAM_ForOP_DEFER_ACTION()
        {
            ...
            if (Common.IsRequirementEnabled(740, this.Site))
            {
                ...
                Site.CaptureRequirementIfIsTrue(
                    isVerifyR740,
                    740,
                    @"[In PidTagDamOriginalEntryId Property] This PidTagDamOriginalEntryId property ([MS-OXPROPS] section 2.659) MUST be set to the EntryID of the delivered (target) message that the client has to process.");
            }
            ...
            if (Common.IsRequirementEnabled(741, this.Site))
            {
                ...
                Site.CaptureRequirementIfIsTrue(
                    isVerifyR741,
                    741,
                    @"[In PidTagRuleFolderEntryId Property] The PidTagRuleFolderEntryId property ([MS-OXPROPS] section 2.948) MUST be set to the EntryID of the folder where the rule (2) that triggered the generation of this DAM is stored.");
            }
            ...
            Site.CaptureRequirementIfAreEqual<string>(
                ...
                359,
                @"[In PidTagRuleProvider] The PidTagRuleProvider property ([MS-OXPROPS] section 2.960) MUST be set to the same value as the PidTagRuleProvider property on the rule or rules that have generated the DAM.");
            ...
            Site.CaptureRequirementIfIsTrue(
                isVerifyR354,
                354,
                @"[In PidTagDamBackPatched property] The PidTagDamBackPatched property ([MS-OXPROPS] section 2.658) MUST be set to ""FALSE"" when the DAM is generated.");
