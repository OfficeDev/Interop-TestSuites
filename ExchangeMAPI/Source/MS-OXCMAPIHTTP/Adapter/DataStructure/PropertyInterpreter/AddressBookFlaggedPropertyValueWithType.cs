namespace Microsoft.Protocols.TestSuites.MS_OXCMAPIHTTP
{
    ...
    public class AddressBookFlaggedPropertyValueWithType : AddressBookPropertyValue
    {
        ...
        /// <summary>
        /// An 8-bit unsigned integer. This flag MUST be set one of three possible values: 0x0, 0x1, or 0xA, which determines what is conveyed in the AddressBookPropertyValue field.
        /// </summary>
        private byte flag;

        /// <summary>
        /// Gets or sets an 8-bit unsigned integer. This flag MUST be set one of three possible values: 0x0, 0x1, or 0xA, which determines what is conveyed in the AddressBookPropertyValue field.
        /// </summary>
        public byte Flag
        {
        ...
        public override void Parse(Context context)
        {
            ...
            switch (this.Flag)
            {
                // Indicates AddressBookPropertyValue presents
                case 0:
                    break;

                // Indicates AddressBookPropertyValue not presents
                case 1:
                    return;
